...
func addCodebaseTests() []test {
	return []test{
		...
		},
		{
			...
			output: "\nERROR: Value cannot be empty [arg_name=version_tag]:\n" + addCodebaseUsage(),
			errStr: "value cannot be empty [arg_name=version_tag]",
		},
		{
		...
		},
		{
			...
			errStr: "version tag already exists [version_tag='go1.21.4'] [project='golang']",
			queries: &app.DataStoreQueriesStub{
				LoadProjectByNameFunc:                 LoadFoundProjectByNameStub,
